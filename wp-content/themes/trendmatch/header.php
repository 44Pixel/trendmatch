...
<html>
	...
	<div class="site-wrapper">
		...
		<div class="navbar-wrapper container desktop-only">
			<a class="logo" href="/">
				<img src="/wp-content/uploads/2018/05/trendmatch-logo-color-horizontal.svg" alt="Trendmatch horizontal logo in color with text">
			</a>
			<?php
				wp_nav_menu( array(
		...
		<div class="navbar-wrapper container mobile-only">
			<a class="logo" href="/">
				<img src="/wp-content/uploads/2018/05/trendmatch-logo-color.png" alt="Trendmatch logo in color with text">	
			</a>
		</div>
		<!-- NAV BAR ENDS -->
